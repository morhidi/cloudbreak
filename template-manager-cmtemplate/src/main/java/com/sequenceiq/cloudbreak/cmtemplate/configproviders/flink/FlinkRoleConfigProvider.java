...
public class FlinkRoleConfigProvider extends AbstractRoleConfigProvider {
    ...
    public static final String HISTORY_SERVER_ARCHIVE_FS_DIR = "historyserver_archive_fs_dir";
    public static final String JOBMANAGER_ARCHIVE_FS_DIR = "jobmanager_archive_fs_dir";
    public static final String STATE_CHECKPOINTS_DIR = "state_checkpoints_dir";
    public static final String STATE_SAVEPOINTS_DIR = "state_savepoints_dir";
    public static final String HIGH_AVAILABILITY_STORAGE_DIR = "high_availability_storage_dir";


    @Override
    protected List<ApiClusterTemplateConfig> getRoleConfigs(String roleType, TemplatePreparationObject source) {
        switch (roleType) {
            case FlinkConstants.FLINK_HISTORY_SERVER:
