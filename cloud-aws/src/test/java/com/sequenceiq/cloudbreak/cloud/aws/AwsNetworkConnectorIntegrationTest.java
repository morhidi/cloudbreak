...
public class AwsNetworkConnectorIntegrationTest {
    ...
    public void createNetworkWithSubnetsAwsBackoffSyncPollingSchedulerException() throws InterruptedException, ExecutionException, TimeoutException {
        ...
        verify(awsPollTaskFactory).newAwsCreateNetworkStatusCheckerTask(any(AmazonCloudFormationClient.class), any(StackStatus.class), any(StackStatus.class),
                any(), any(NetworkCreationRequest.class));
    }
    ...
    public void deleteNetworkWithSubnetsSchedulerThrowsError() throws TimeoutException, ExecutionException, InterruptedException {
        ...
        assertThatThrownBy(() -> testAwsNetworkConnector.deleteNetworkWithSubnets(createNetworkDeletionRequest(Boolean.FALSE)))
                ...
                .hasMessage("Process Interrupted");
        verify(awsClient).createCloudFormationClient(any(AwsCredentialView.class), any());
        verify(awsPollTaskFactory).newAwsTerminateNetworkStatusCheckerTask(any(AmazonCloudFormationClient.class), any(StackStatus.class),
                any(StackStatus.class), any(), any());
    }
    ...
    public void deleteNetworkWithSubnetsSuccessfull() throws InterruptedException, ExecutionException, TimeoutException {
        ...
        verify(awsPollTaskFactory).newAwsTerminateNetworkStatusCheckerTask(any(AmazonCloudFormationClient.class), any(StackStatus.class), any(StackStatus.class),
                any(), any());
