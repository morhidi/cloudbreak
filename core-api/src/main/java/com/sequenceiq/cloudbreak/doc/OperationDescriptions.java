...
public class OperationDescriptions {
    ...
    public static class StackOpDescription {
        ...
        public static final String DATABASE_BACKUP = "Backs up the datalake database";
        public static final String DATABASE_RESTORE = "Restores up the datalake database";
    }
